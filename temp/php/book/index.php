...
<body>
 ...
 <div class="container-fluid">
	...
	$filename= $obj->getFirstImagePath($book_id);
	$src = "../../files/images/$book_id/$filename";
	...
	<div clas="span4">
		...
		<span class="label label-important">success</span>
		<span class="label label-info">Info</span>
    ...
    <div class="span12">
        ...
        <div class="bookTitle">
			<blockquote>
            <p>
		<?php echo '<a href="../../reader/index.php?bookId='.$book_id.'" target="_blank">'.ucwords($obj->getTitle($book_id)).'</a>';?>
              </p>
...
<br />
		...
		This box
		is  for descption of bookThis box
		is  for descption of bookThis box
		is  for descption of bookThis box
		is  for descption of bookThis box
		is  for descption of bookThis box
		...
		is  for descption of bookThis box
		is  for descption of bookThis box
		is  for descption of book
		is  for descption of book<br />
