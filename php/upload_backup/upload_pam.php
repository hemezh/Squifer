...
// Settings
	$temp_path = "/var/www/";	
	$temp_path = getcwd() . "/../../uploads/";		// The path were we will save the file (getcwd() may not be reliable and should be tested in your environment)
	$save_path = "/var/myhub/pdf/";
	$upload_name = "Filedata";
	$max_file_size_in_bytes = 2147483647;				// 2GB in bytes
	$extension_whitelist = array("jpg", "gif", "png","pdf","mp3");	// Allowed file extensions
...
echo $temp_path.$file_name;
	...
	exec('mkdir /var/myhub/images/'.$file_name);
	$var="gs -dNOPAUSE -sDEVICE=jpeg -r144 -sOutputFile=/var/myhub/images/".$file_name."/p%03d.jpg  ".$temp_path.$file_name;
	//exec(mv $temp_path.'/'.$file_name '/var/myhub/pdf'.$file_name);
	exec($var);
	exec("mv $temp_path.$file_name $save_path.$file_name");
	//$author="";
//	$tags="";
